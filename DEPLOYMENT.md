...
```bash
HAOKANG_API_BASE_URL=https://api.haokang.com  # 好慷API基础URL
HAOKANG_API_KEY=your-api-key  # 好慷API密钥
...
### 5.2 配置好慷后端
在好慷后端服务中，配置Dify Agent的API地址和密钥：
