...
基于Dify Agent实现的好慷全能管家AI智能助理，提供服务笔记查询、订单管理等功能。
...
```bash
export HAOKANG_API_BASE_URL="https://api.haokang.com"  # 好慷API基础URL
export HAOKANG_API_KEY="your-api-key"  # 好慷API密钥
...
2. **好慷后端(BFF/GateWay)**：处理用户请求，转发给Dify Agent
